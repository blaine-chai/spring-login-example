            ...
            <div id="search-wrapper">
                ...
                <div class="btn-group" style="padding-top: 5px; width: 100%; margin:0;">
                    ...
                    <div id="admin-history" class="panel history"
                         style="display:block;overflow: scroll; max-height:500px; margin-left: 2px; margin-right: 2px; display: none;">
                        <table style="font-size:11px;max-height: 300px; overflow: scroll"
                               class="table table-fixed table-bordered table-striped table-condensed">
                            <tbody></tbody>
                        </table>
                ...
                <div class="btn-group" style="padding-top: 5px; width: 100%;margin:0;">
                    ...
                    <div id="user-history" class="panel history"
                         style="overflow: scroll; max-height:500px; margin-left: 2px; margin-right: 2px; display: none;">
                        <table style="font-size:11px;max-height: 400px; overflow: auto; width:300px"
                               class="table table-fixed table-bordered table-striped table-condensed">
                            <tbody></tbody>
                        </table>
                    </div>
